...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-04-2022 a las 22:17:20
...
(141, 41, '2022-04-06', '10:00:00', 1, '17:30:00', 6.5);
...
(9, '2022-04-06', '40', '6304240', 4),
(10, '2022-04-06', '42', '13127064', 8);
...
INSERT INTO `cargos` (`id`, `description`, `rate`) VALUES
...
--
-- Estructura de tabla para la tabla `deducciones3`
--
...
--
-- Volcado de datos para la tabla `deducciones3`
--

INSERT INTO `deducciones3` (`id`, `description`, `amount`) VALUES
(5, 'INCES 1%', '0.01');
...
(38, '14450022', 'Willian', 'Cañizales', 'Calle 1ro de Mayo, Casa N°546. Cementerio, Caracas.', '1980-06-01', 'N/A', 'Male', 5, 3, '', '2022-04-06'),
(39, '14452990', 'Dayurimare', 'Gonzalez', '23 de Enero', '1977-01-15', 'N/A', 'Female', 7, 2, '', '2022-04-06'),
(40, '6304240', 'Giuseppe', 'Lodise', 'Propatria', '1952-12-12', 'N/A', 'Male', 8, 3, '', '2022-04-06'),
(41, '16894094', 'Lurdes', 'Escalona', 'Parque Central', '1984-01-23', 'N/A', 'Female', 3, 4, '', '2022-04-06'),
(42, '13127064', 'Yurvin', 'Boada', 'Macaracuay', '1976-08-05', 'N/A', 'Female', 8, 2, '', '2022-04-06');
...
INSERT INTO `vehiculos` (`id`, `serial_carroceria`, `serial_motor`, `placa`) VALUES
(1, '2345879', 'vha4555', 'RD180K');
...
--
-- Indices de la tabla `deducciones3`
--
ALTER TABLE `deducciones3`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `deducciones3`
--
ALTER TABLE `deducciones3`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
