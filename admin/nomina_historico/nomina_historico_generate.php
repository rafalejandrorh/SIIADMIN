                ...
                foreach($obtener_historico_nomina as $row)
                    {
                        ...
                        <td align="right">'.date('d-m-Y', strtotime($row['fecha_inicio_nomina'])).'</td>
                        <td align="right">'.date('d-m-Y', strtotime($row['fecha_final_nomina'])).'</td>
                        </tr>';
                }
                $contents .= '';
                return $contents;
	...
	require_once('../../tcpdf_min/tcpdf.php');  
        ...
        $content .= '
                ...
                <table border="1" cellspacing="0" cellpadding="3">  
                        <tr>
                        <th width="11,1%" align="center"><b>Fecha Emisión</b></th>  
                        ...
                        <th width="11,1%" align="center"><b>Total Deducciones</b></th>
                        <th width="9,1%" align="center"><b>Tasa Dolar</b></th>
                        <th width="11,1%" align="center"><b>Salario Neto en Dólares</b></th>
                        <th width="11,1%" align="center"><b>Salario Neto en Bolivares</b></th>
                        <th width="11,1%" align="center"><b>Fecha Inicio</b></th>  
                        <th width="11,1%" align="center"><b>Fecha Final</b></th>    
                        </tr> ';
