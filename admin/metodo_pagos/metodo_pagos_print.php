<?php
    ...
    foreach($obtener as $row){
        ...
        <td align="right">'.'$ '.number_format($row['sueldo'], 2).'</td>
				<td align="center">'.date('h:i A', strtotime($row['hora_llegada'])).' - '. date('h:i A', strtotime($row['hora_llegada'])).'</td>
        <td align="center">'.$row['direccion'].'</td>
        <td align="center">'.$row['numero_contacto'].'</td>
			</tr>
			';
		}
    ...
    $content .= '
      	...
      	<table border="1" cellspacing="0" cellpadding="3">  
           <tr>
              <th width="12%" align="center"><b>Cédula de Identidad</b></th>  
           		<th width="16%" align="center"><b>Nombre Empleado</b></th>
