<?php 
  ...
  if($_SESSION['perfil'] == 8000 || $_SESSION['perfil'] == 8001 || $_SESSION['perfil'] == 8002 || $_SESSION['perfil'] == 8004)
  {
  ?>
...
$(function(){
  $('#select_year').change(function(){
    window.location.href = 'finanzas.php?year='+$(this).val();
  });
});
</script>
</body>
